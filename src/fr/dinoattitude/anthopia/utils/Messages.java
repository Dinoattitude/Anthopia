...
public enum Messages {
	...
	INCORRECT_ARGS("not-enough-args", "§cLe nombre d'arguments spécifiés est incorrect."),
	NO_PERMS("no-permissions", "§cVous n'avez pas les permissions necessaires pour effectuer cette action."),
	NO_GUILD("no-guild", "§cVous n'apartenez à aucune guilde"),
	GUILD_NOT_FOUND("guild-not-found", "§cLa guilde spécifié en paramètre n'existe pas."),
	ERR_NOT_FOUND("err-not-found", "§Anthopia pas trouvé de résultat pour cette requête."),
